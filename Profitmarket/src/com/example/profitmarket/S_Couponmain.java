...
public class S_Couponmain extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.s_couponmain);
		  StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
	        StrictMode.setThreadPolicy(policy);
		Button button1 = (Button) this.findViewById(R.id.cmbtnb);
		Button button2 = (Button) this.findViewById(R.id.cmbtna);
	...
	private void replaceFragment(Fragment fragment) {
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        ...
	        if (keyCode == KeyEvent.KEYCODE_BACK)
	        {
	    	    ...
	    	    intent.setClass(S_Couponmain.this,S_Mainmenu.class);
