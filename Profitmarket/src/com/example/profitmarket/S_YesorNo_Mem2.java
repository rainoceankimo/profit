...
public class S_YesorNo_Mem2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_s__yesor_no__mem2);
	...
	PreviewCallback previewCb = new PreviewCallback() {
		public void onPreviewFrame(byte[] data, Camera camera) {
			...
			final String result = zBarDecoder.decodeCrop(rotatedData, size.width, size.height, mCropRect.left, mCropRect.top, mCropRect.width(), mCropRect.height());
	  ...
	  public void back_seattle_onClick(View v){
			Intent intent = new Intent(); 
			intent.setClass(S_YesorNo_Mem2.this,S_SettleaCcounts.class);
