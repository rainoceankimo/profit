...
public class AppConfig_Stores {
    ...
    public static String url_get_recordtoAIRuse = "http://chaoiok.net78.net/analysis/get_coupon_used.php";
    
    //use to S_Analysis_Sources
    public static String url_get_recordtoAS = "http://chaoiok.net78.net/analysis/get_all_receive.php"; 
    
    //use to S_Analysis_Whereabouts
    public static String url_get_recordtoAW = "http://chaoiok.net78.net/analysis/get_all_issue.php"; 
